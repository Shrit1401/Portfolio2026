...
const PastTell = () => {
  ...
  useEffect(() => {
    ...
    if (!root || PAST_STEP_COUNT === 0) return;
  ...
  useEffect(() => {
    ...
    const root = listRef.current;
    if (!journey || !track || !progressEl || !root || PAST_STEP_COUNT === 0)
      return;
  ...
  return (
    <section className="pasttell-section relative flex min-h-screen w-full items-start justify-center overflow-x-hidden pb-28 pt-16 md:pb-36 md:pt-24">
      ...
      <div className="relative z-20 w-full max-w-3xl px-5 md:max-w-4xl md:px-8 md:pl-9">
        ...
        <div ref={journeyRef} className="pasttell-journey relative md:pl-1">
          ...
          <div ref={listRef} className="relative z-10 flex flex-col">
            {PAST_TIMELINE_ROWS.map(
              ...
              const cardEmphasis =
                isMilestone ? "md:scale-[1.03]" : isLatest ? "md:scale-[1.015]" : "";
              ...
              return (
                <React.Fragment key={`${chapter.id}-${event.title}-${idx}`}>
                  {isFirstInChapter ? (
                    <div
                      className="pasttell-section-break relative z-10 mb-12 mt-6 first:mt-0 md:mb-14 md:mt-10 md:pl-[3.25rem]"
                    >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        height: dotSize,
                        marginLeft:
                          isMilestone ? -2 : isLatest ? -1 : idx % 2 === 0 ? 0 : 1,
                        background: accent,
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="absolute right-5 top-5 z-10 flex max-w-[calc(100%-1.5rem)] flex-col items-end gap-1.5 text-right md:right-8 md:top-8 md:max-w-[13rem]">
                          {isMilestone ? (
                        ...
                        <div className="max-w-[50ch] min-w-0 pr-[7.25rem] sm:pr-[8.25rem] md:pr-[9.25rem]">
